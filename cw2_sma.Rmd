...
## Sentiment Analysis
This code will perform the sentiment analysis comparison of Islam tweets and Christian tweet, by using the get_nrc_sentiment function to do so. This bit also uses the dataframes read from the CSV files in the word cload section.
```{r}
...
## Emotion Plot
This section will perform the emotion plot coparison of Islam tweets and Christian tweets. It extract the emotion information from the results of the get_nrc_sentiment function. This bit also uses the dataframes read from the CSV files in the word cload section.
```{r}
# Muslim Tweets
