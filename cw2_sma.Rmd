...
## Display graphs with plotly
#Visualize the emotions from NRC sentiments
# plot_ly(emo_sum_muslim, x=~emotion, y=~percent, type="bar", color=~emotion) %>%
# layout(xaxis=list(title=""),  yaxis = list(title = "Emotion count"),
# showlegend=FALSE,title="Distribution of emotion categories on  Muslim Tweets") %>%
# layout(yaxis = list(ticksuffix = "%"))

#Visualize the emotions from NRC sentiments
# plot_ly(emo_sum_christian, x=~emotion, y=~percent, type="bar", color=~emotion) %>%
# layout(xaxis=list(title=""),  yaxis = list(title = "Emotion count"),
# showlegend=FALSE,title="Distribution of emotion categories on Christian Tweets") %>%
# layout(yaxis = list(ticksuffix = "%"))

# subplot(Viz_ed_muslim, Viz_ed_christian, showlegend = FALSE)
